...
const ForgotPass = () => {
  ...
  return (
    <div className="h-screen w-full  flex  bg-[linear-gradient(180deg,#051424_0%,#020817_100%)] justify-center items-center">
      {State==1 &&
       <div className="bg-slate-900 w-[40%] border border-gray-500 rounded-xl text-white h-[50%]">
        ...
        <div className=" px-15 flex  flex-col">
          ...
          <div onClick={()=>setState(2)} className="bg-sky-700 hover:bg-sky-500 transition-all py-2 mb-5 rounded-md px-2 placeholder:text-md">
            <p className="font-['ibm_plex_mono'] text-center ">Send Email</p>
          </div>

          <div onClick={()=>{navigate("/login")}} className="py-2 flex gap-1 hover:gap-3 hover:text-sky-500 transition-all items-center justify-center rounded-md px-2 placeholder:text-md">
            <IoIosArrowBack className="h-6 w-6 " />
            <p className="font-['ibm_plex_mono'] text-center ">Back to Login</p>
          </div>
        </div>
      </div>}
      ...
      {State==2 &&
       <div className="bg-slate-900 w-[40%] border border-gray-500 rounded-xl text-white h-[50%]">
        ...
        <div className=" px-15 flex  flex-col">
          ...
          <div onClick={()=>setState(3)}  className="bg-sky-700 hover:bg-sky-500 transition-all py-2 mb-5 rounded-md px-2 placeholder:text-md">
       ...
       <div className="bg-slate-900 w-[40%] border border-gray-500 rounded-xl text-white h-[60%]">
        ...
        <div className=" px-15 flex  flex-col">
          ...
          <div className="bg-sky-700 hover:bg-sky-500 transition-all py-2 mb-4 rounded-md px-2 placeholder:text-md">
            <p className="font-['ibm_plex_mono'] text-center ">Change Password</p>
          </div>
